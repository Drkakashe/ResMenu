    ...
    <div class="max-w-md w-full relative z-10 animate-fade-in-up">
      <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 sm:p-10 hover:border-white/30 transition-all duration-300">
        ...
        <div class="text-center mb-8">
          ...
          <p class="mt-2 text-white font-medium text-lg">{{ $t('auth.registerTitle') }}</p>
          <p class="text-sm text-gray-300 mt-1">{{ $t('auth.registerSubtitle') }}</p>
        </div>
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <div>
            <label for="restaurantName" class="block text-sm font-medium text-gray-200 mb-2">
          ...
          <div>
            <label for="contactPhone" class="block text-sm font-medium text-gray-200 mb-2">
              {{ $t('auth.contactPhone') }}
            </label>
            <input
              id="contactPhone"
